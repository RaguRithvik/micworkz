...
const CmtCardExpendableContent = ({ actionsComponent, className, actionsClasses, contentClass, children, ...rest }) => {
  ...
  return (
    <Box className={clsx(classes.root, className, 'CmtCard-ExpendableContent-root')} {...rest}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CmtCardContent className={clsx(contentClass, 'CmtCard-ExpendableContent')}>{children}</CmtCardContent>
      </Collapse>
    </Box>
  );
};
