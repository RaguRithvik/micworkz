...
const issuesed=[
    {issues: "Room Cooling problem"},{issues: "Room Small problem"},{issues: "Bathroom Cleaning Problem"},{issues: "Unconfertable"}
];
const issusednow=[
    {issues: "Staff in Helples"},{issues: "Telecome Not working"},{issues: "Hotel Management Issues"},{issues: "Money Issues"}
];
            ...
            <section className={classes.HotelLanguageSection}>
                ...
                <Container>
                    <Box className={classes.LanguageInformationnower}>
                         <h3 className={classes.Roomcommonheader}>Issues Types</h3>
                ...
                <Container>
                    <Box className={classes.LanguageInformationnower}>
                         <h3 className={classes.Roomcommonheader}>Issues Now</h3>
                         <Box className={classes.LanguageHoredcheckup}>
                            <Button variant="outlined" color="primary" className={classes.RoomAmenityAdded}>Add</Button>
                          </Box>
                    </Box>
                    <Row>
                    {issusednow.map((val, index) => (
                        <Column md="3" padding={[0,10]}>
                           <Box className={classes.RoomAmenitiesInformation}>
                                <li><Checkbox
                                    size="small"
