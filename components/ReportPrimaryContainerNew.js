...
const ReportPrimaryContainerNew = (props) => {
  const { children, data, filter_object, loader, currIndex, maxPage, setCurrIndex, setPageSize, pageSize, showCol, hidePagination, colSpanValue } = props;
          ...
          {data ? <TableContainer>
            <Table className={classes.table} size="small" aria-label="a dense table">
              ...
              {loader ?
                <TableBody>
                  <TableRow>
                    <TableCell scope="row" align="center" colSpan={colSpanValue} rowSpan={2}>
...
export default ReportPrimaryContainerNew;

const Header = (props) => {
  const { classes, formName, search_key, search, addEdit, setShowCol, showCol, updateShowCol, loadData } = props;
  ...
  return (
    <Row>
      <Column md={6} center className={classes.btnMargin}>
        <Row >
          <div ref={filterRef}>
      ...
      <Column md={6} right className={classes.searchAndActionContainer}>
