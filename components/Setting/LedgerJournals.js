                            ...
                            <Fade in={addEdit}>
                                <Row>
                                    <Column style={{ backgroundColor: '#003399' }} padding={[8]}>
                                        <Text bold size={16} color="white">Ledger Journals</Text>
                                    </Column>
                                    <Column>
                                          ...
                                          <Column md={4} padding={[10, 5]}>
                                            ...
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">Trans Type *</InputLabel>
                                                <Select
                                                    size="small"
                                                ...
                                                <MenuItem value={10}>Rec</MenuItem>
                                        ...
                                        <Row>
                                            ...
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                ...
                                                <MenuItem value={10}>Han-Himalayan (CASH) (CUSTOMER)</MenuItem>
                                                <MenuItem value={20}></MenuItem>
                                                <MenuItem value={30}></MenuItem>
                                                </Select>
                                            </FormControl>
                                           ...
                                           <Column md={4} padding={[15, 5]}>
                                            ...
                                            <Column md={3} padding={[15, 5]}>
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">Mode Of Pay</InputLabel>
                                                <Select
                                                    size="small"
                                                    labelId="demo-simple-select-outlined-label"
                                                    id="demo-simple-select-outlined"
