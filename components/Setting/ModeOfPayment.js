                            ...
                            <Fade in={addEdit}>
                                <Row>
                                    <Column style={{ backgroundColor: '#003399' }} padding={[8]}>
                                        <Text bold size={16} color="white">Mode Of Pay</Text>
                                    </Column>
                                    <Column>
                                    <Row>
                                    ...
                                    <Column md={3} padding={[15, 5]}>
                                        ...
                                        <Row>
                                        <Column md={3} padding={[15, 5]}></Column>
                                            <Column md={4} padding={[15, 5]}>
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">LEDGER GROUP *</InputLabel>
                                                <Select
                                                    size="small"
                                            ...
                                            <Column md={4} padding={[15, 5]}>
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">LEDGER *</InputLabel>
                                                <Select
                                                    size="small"
                                                    labelId="demo-simple-select-outlined-label"
                                                    id="demo-simple-select-outlined"
                                             ...
                                             <Column md={4} padding={[15, 5]}>
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">Remarks Field1 Type *</InputLabel>
                                                <Select
                                                    size="small"
                                                    labelId="demo-simple-select-outlined-label"
                                                    id="demo-simple-select-outlined"
                                            ...
                                            <Column md={4} padding={[15, 5]}>
                                             ...
                                             <Column md={4} padding={[15, 5]}>
                                            <FormControl variant="outlined" className={classes.formControl}>
                                                <InputLabel id="demo-simple-select-outlined-label">Remarks Field2 Type *</InputLabel>
                                                <Select
                                                    size="small"
                                                    labelId="demo-simple-select-outlined-label"
                                                    id="demo-simple-select-outlined"
